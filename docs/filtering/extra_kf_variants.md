...
1. Julier, S. J., & Uhlmann, J. K. (1997). *New extension of the Kalman filter to nonlinear systems*. Proc. SPIE 3068, Signal Processing, Sensor Fusion, and Target Recognition VI, 182-193. https://doi.org/10.1117/12.280797 - the original UKF paper behind §1; already cited in [kf_ekf_iekf.md §14](kf_ekf_iekf.md#14-references).
2. Solà, J. (2017). *Quaternion kinematics for the error-state Kalman filter*. arXiv:1711.02508. https://arxiv.org/abs/1711.02508 - the standard ESKF reference behind §2; already cited in [kf_ekf_iekf.md §14](kf_ekf_iekf.md#14-references).
3. Barrau, A., & Bonnabel, S. (2017). *The Invariant Extended Kalman Filter as a Stable Observer*. IEEE Transactions on Automatic Control, 62(4), 1797-1812. https://arxiv.org/abs/1410.1465 - the IEKF paper behind §4; already cited in [kf_ekf_iekf.md §14](kf_ekf_iekf.md#14-references).
